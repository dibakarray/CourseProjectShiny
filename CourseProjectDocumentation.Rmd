...
## How to Use
A simple user interface is available to user who wants to find out or explore Fuel Efficienct (miles per gallon) for a given set of input - displacement, number of cylinders and weight of the car.
...
In order to input weight of the car,user needs to user 'Weight'slider. Slider takes values from 1500 to 5500 Ibs.
...
As the user changes input on the side panel the user can see the inputs given and the predicted Fuel efficinecy in miles per gallon.
